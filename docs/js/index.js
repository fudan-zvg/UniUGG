...
window.onload = function() {
    ...
    setup_render_divs("case1", './models/case1.ply')
    setup_render_divs("case2", './models/case1.ply')
    setup_render_divs("case3", './models/case1.ply')
    setup_render_divs("case4", './models/case1.ply')
    setup_render_divs("case5", './models/case1.ply')
    setup_render_divs("case6", './models/case1.ply')
    setup_render_divs("case7", './models/case1.ply')
    setup_render_divs("case8", './models/case1.ply')
    
    setup_render_divs("meshseed1", './models/case1.ply')
    setup_render_divs("meshseed2", './models/case1.ply')
};
