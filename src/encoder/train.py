...
from mast3r.losses import ConfMatchingLoss, MatchingLoss, APLoss, Regr3D, InfoNCE, Regr3D_ScaleShiftInv, SemanticLossFeat, SemanticLossSummary
...
dust3r.training.SemanticLossFeat = SemanticLossFeat
dust3r.training.SemanticLossSummary = SemanticLossSummary
