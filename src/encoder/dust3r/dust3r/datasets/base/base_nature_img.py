...
class BaseNatureImg(EasyDataset):
    ...
    def _crop_resize_if_necessary(self, image, resolution, rng=None):
        """ This function:
        ...
        image = cropping.rescale_image(image, target_resolution)
