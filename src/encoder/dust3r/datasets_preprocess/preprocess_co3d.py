...
def get_parser():
    ...
    parser.add_argument('--single_sequence_subset', default=True, action='store_true',
                        help="prepare the single_sequence_subset instead.")
    parser.add_argument("--output_dir", type=str, default="data/co3d_subset_processed")
    parser.add_argument("--co3d_dir", type=str, default="data/co3d_subset")
